<%@ page language="java" contentType="text/html; charset=UTF-8" 
    pageEncoding="UTF-8"%>
<%@ page import="model.bean.nguoidung,model.bean.ve  ,java.util.List"%>
   ...
   <div class="container mt-5">
    ...
    <ul class="nav nav-tabs" id="orderTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="current-tab" data-bs-toggle="tab" data-bs-target="#current" type="button" role="tab">Hiện tại</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="completed-tab" data-bs-toggle="tab" data-bs-target="#completed" type="button" role="tab">Đã đi</button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content p-4" id="orderTabsContent">
       <%
       List<ve> veList = (List<ve>) request.getAttribute("veList");
