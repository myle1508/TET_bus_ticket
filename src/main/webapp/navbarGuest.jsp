          ...
          <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                  <div class="navbar-nav ms-auto">
                      ...
                      if (username != null){
                    	%>
                      <a href="donhang.jsp" class="nav-item nav-link">Quản lý vé đã đặt</a>
                      <a href="thongtin_nguoidung.jsp" class="nav-item nav-link">Thông tin tài khoản</a>
                      	<% 
                      } %>
                  ...
                  <% if (username != null){
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="guest_servlet?logout=1" class="dropdown-item">Đăng xuất</a>
                        </div>
                    </div>
                   <%}
                  else {
